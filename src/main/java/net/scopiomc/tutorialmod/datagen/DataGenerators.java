...
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        ModBlocksTagGenerator blocksTagGenerator = generator.addProvider(event.includeClient(),
                new ModBlocksTagGenerator(packOutput, lookupProvider, existingFileHelper));
        generator.addProvider(event.includeServer(), new ModItemsTagGenerator(packOutput, lookupProvider, blocksTagGenerator
